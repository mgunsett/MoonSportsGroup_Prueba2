...
export default function Contact() {
  const sectionRef  = useGsapReveal('up', 0.12)
  ...
  return (
    <Box
      ...
      bg="brand.grayDark"
    >
      <Box maxW="1280px" mx="auto" px={{ base: 6, md: 12 }} textAlign="center" ref={sectionRef}>
        <Text className="section-label gsap-reveal" style={{ justifyContent: 'center' }}>
          Ponte en Contacto
        </Text>
